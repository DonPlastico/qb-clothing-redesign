...
-- Establezca en true o false o GetConvar('UseTarget', 'false') == 'true' para usar una opción global o específica del script.
-- Deben ser una cadena debido a la forma en que se devuelven las Convars.
Config.UseTarget = false

-- width, length, minZ and maxZ son para el tamaño y altura del PolyZone
Config.Stores = {
    [1] = {shopType = 'clothing', coords = vector3(1697.03, 4827.99, 42.06), width = 3, length = 3},
    [2] = {shopType = 'clothing', coords = vector3(-704.29, -151.87, 37.42), width = 3, length = 3},
    [3] = {shopType = 'clothing', coords = vector3(-1188.20, -768.72, 17.33), width = 3, length = 3},
    [4] = {shopType = 'clothing', coords = vector3(429.47, -801.40, 29.49), width = 3, length = 3},
    [5] = {shopType = 'clothing', coords = vector3(-167.81, -299.39, 39.73), width = 3, length = 3},
    [6] = {shopType = 'clothing', coords = vector3(71.88, -1397.77, 29.38), width = 3, length = 3},
    [7] = {shopType = 'clothing', coords = vector3(-828.37, -1072.86, 11.33), width = 3, length = 3},
    [8] = {shopType = 'clothing', coords = vector3(-1447.46, -242.43, 49.82), width = 3, length = 3},
    [9] = {shopType = 'clothing', coords = vector3(10.85, 6513.06, 31.88), width = 3, length = 3},
    [10] = {shopType = 'clothing', coords = vector3(617.46, 2766.52, 42.09), width = 3, length = 3},
    [11] = {shopType = 'clothing', coords = vector3(1191.77, 2713.80, 38.22), width = 3, length = 3},
    [12] = {shopType = 'clothing', coords = vector3(-3175.28, 1041.93, 20.86), width = 3, length = 3},
    [13] = {shopType = 'clothing', coords = vector3(-1107.55, 2710.15, 19.11), width = 3, length = 3},
    [14] = {shopType = 'clothing', coords = vector3(121.03, -226.05, 54.56), width = 3, length = 3},
    [15] = {shopType = 'barber', coords = vector3(-814.3, -183.8, 36.6), width = 3, length = 3},
    [16] = {shopType = 'barber', coords = vector3(136.8, -1708.4, 28.3), width = 3, length = 3},
    [17] = {shopType = 'barber', coords = vector3(-1282.6, -1116.8, 6.0), width = 3, length = 3},
    [18] = {shopType = 'barber', coords = vector3(1931.5, 3729.7, 31.8), width = 3, length = 3},
    [19] = {shopType = 'barber', coords = vector3(1212.8, -472.9, 65.2), width = 3, length = 3},
    [20] = {shopType = 'barber', coords = vector3(-32.9, -152.3, 56.1), width = 3, length = 3},
    [21] = {shopType = 'barber', coords = vector3(-278.1, 6228.5, 30.7), width = 3, length = 3}
}

-- Establece isGang en true si el trabajo requerido es una banda
Config.ClothingRooms = {
    [1] = {requiredJob = 'police', isGang = false, coords = vector3(464.49, -1001.69, 30.71), width = 2, length = 2, cameraLocation = vector4(467.04, -1001.68, 30.71, 89)},
    [2] = {requiredJob = 'police', isGang = false, coords = vector3(464.91, -998.42, 30.71), width = 2, length = 2, cameraLocation = vector4(467.33, -998.28, 30.71, 89)},
    [3] = {requiredJob = 'police', isGang = false, coords = vector3(-437.14, 6009.98, 37.00), width = 2, length = 2, cameraLocation = vector4(-439.05, 6007.94, 37.00, 313)},
    [4] = {requiredJob = 'police', isGang = false, coords = vector3(-438.85, 6011.44, 37.00), width = 2, length = 2, cameraLocation = vector4(-440.42, 6009.91, 37.00, 313)},
    [5] = {requiredJob = 'ambulance', isGang = false, coords = vector3(-1814.35, -353.49, 49.47), width = 2, length = 2, cameraLocation = vector4(-1815.72, -355.12, 49.46, 323)},
    [6] = {requiredJob = 'ambulance', isGang = false, coords = vector3(-1820.01, -359.98, 49.45), width = 2, length = 2, cameraLocation = vector4(-1818.28, -357.99, 49.46, 137)}
}
...
Config.AllowPlayerModels = true -- Establece en 'true' para permitir que los jugadores puedan elegir modelos de peds, 'false' para deshabilitarlo.
